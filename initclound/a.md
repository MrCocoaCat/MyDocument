https://blog.csdn.net/bbwangj/article/details/79567184
...
userdata文件可以有多个格式，具体参见：http://cloudinit.readthedocs.org/en/latest/topics/format.html
...
--===============2197920354430400835==--
cloudinit从数据源中拿到该userdata后，首先会对其进行切分，并分别供各模块处理。例如抽取cloud-config部分，如：
...
cloudinit中所有的模块都放在/usr/lib/python2.7/dist-packages/cloudinit/CloudConfig/下，具体用法可以直接研究代码或者参考http://cloudinit.readthedocs.org/en/latest/index.html
...
作者：韦远科
来源：CSDN
原文：https://blog.csdn.net/weiyuanke/article/details/23789069
